...
class TestGroup < Minitest::Test
  ...
  def test_case_1
    @game.load_moves("a2,a1,b2,b1,c2,d1,pass,e1,c1")
  ...
  def test_shared_lives2
    @game.load_moves("a1,pass,a3,pass,b3,pass,b1,pass,c1,pass,c3,pass,c2")
  ...
  def test_merge_and_around
    ...
    3.times do
      ...
      assert_equal(BLACK, @game.cur_color) # otherwise things are reversed below
      @game.load_moves("c2,b2,pass,b4,b3,undo,b4,pass,b3")
      # +++++ 5 +++++
      # +@@++ 4 +@@++
      # OOO++ 3 O@O++
      # @@O++ 2 @@O++
      ...
      @game.load_moves("undo,undo,undo")
  ...
  def test_undo_2
    ...
    @game.load_moves("c3,a2") # and kill again the same
    assert_equal(0,wg.lives)
    assert_equal(EMPTY,ws.color)
    assert_equal(true,ws.group == nil)
  end

...
TestGroup.prototype.test_group_merge = function () {
    // check the sentinel
    assert_equal(1, this.goban.merged_groups.size() + error_both_var_and_method('size'));
    assert_equal(-1, this.goban.merged_groups[0].color);
    assert_equal(1, this.goban.killed_groups.size() + error_both_var_and_method('size'));
    ...
    assert_equal(2, this.goban.merged_groups.size() + error_both_var_and_method('size'));
...
TestGroup.prototype.check_group = function (g, ndx, num_stones, color, stones, lives) {
    ...
    assert_equal(num_stones, g.stones.size() + error_both_var_and_method('size'));

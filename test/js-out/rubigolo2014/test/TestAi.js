...
/** @class */
function TestAi(xtestName) {
    main.TestCase.call(this, xtestName);
...
TestAi.prototype.xtestCornering = function () {
    // 9 ++++++++O
    // 8 ++++++++@
    // 7 +++@+++++
    // 6 +++++++++
...
TestAi.prototype.xtestPreAtari = function () {
    // 5 +++++++++
    // 4 +@@@@O+++
    // 3 ++O@O@O++
    // 2 ++O@O@+++
...
TestAi.prototype.xtestHunter1 = function () {
...
TestAi.prototype.xtestLadder = function () {
    // 9 O+++++++@
    // 8 ++++++++@
    // 7 ++++++++O
    // 6 ++++++++O
...
TestAi.prototype.xtestLadderBreaker1 = function () {
    // 9 O++++++++
    // 8 O++++++++
    // 7 O+++O++++
    // 6 +++++++++
...
TestAi.prototype.xtestLadderBreaker2 = function () {
    // 9 O++++++++
    // 8 OOO++++++
    // 7 O+++O++++
    // 6 ++*++++++
...
TestAi.prototype.xtestSeeDeadGroup = function () {
    // 9 +@++@@@@O
    // 8 +@@@@@@OO
    // 7 @@+@+@@O+
    // 6 +@+@++@O+
...
TestAi.prototype.xtestSnapback = function () {
    this.initBoard(5);
    // 5 O@+O+
    // 4 O@*@@
    // 3 OO@++
...
TestAi.prototype.xtestSnapback2 = function () {
    this.initBoard(7);
    // 7 O@+OO++
    // 6 O@+@@++
    // 4 OO@@+++
...
TestAi.prototype.xtestSnapback3 = function () {
    this.initBoard(5);
    // 5 O@+OO
    // 4 O@O@+
    // 3 OO@@+
...
TestAi.prototype.xtestSeesAttackNoGood = function () {
    this.initBoard(5);
    // 5 O@@OO
    // 4 O@+@+
    // 3 OO@@+

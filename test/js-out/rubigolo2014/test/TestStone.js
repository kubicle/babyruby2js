...
TestStone.prototype.testHowManyLives = function () {
    ...
    assertEqual(2, this.howManyLives(this.goban.size() + error_both_var_and_method('size'), this.goban.size() + error_both_var_and_method('size')));
    assertEqual(2, this.howManyLives(1, this.goban.size() + error_both_var_and_method('size')));
    assertEqual(2, this.howManyLives(this.goban.size() + error_both_var_and_method('size'), 1));
    assertEqual(4, this.howManyLives(2, 2));
    assertEqual(4, this.howManyLives(this.goban.size() + error_both_var_and_method('size') - 1, this.goban.size() + error_both_var_and_method('size') - 1));

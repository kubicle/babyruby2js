...
TestStone.prototype.testHowManyLives = function () {
    ...
    assertEqual(2, this.howManyLives(this.goban.length, this.goban.length));
    assertEqual(2, this.howManyLives(1, this.goban.length));
    assertEqual(2, this.howManyLives(this.goban.length, 1));
    assertEqual(4, this.howManyLives(2, 2));
    assertEqual(4, this.howManyLives(this.goban.length - 1, this.goban.length - 1));

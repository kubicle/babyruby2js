 ...
 *  public read-only attribute: size, grid, scoringGrid, mergedGroups, killedGroups, garbageGroups
 */
function Goban(size) {
    if (size === undefined) size = 19;
    this.size = size;
    this.grid = new Grid(size);
    this.scoringGrid = new Grid(size);
...
Goban.prototype.image = function () {
    return this.grid.toText(false, ',', function (s) {
